...
resource "aws_iam_role" "ecs_task_execution" {
  name = "ecsTaskExecutionRolelat26"
...
resource "aws_ecs_service" "evolutionapi" {
  name            = "evolutionapi-servicelat26"
...
resource "aws_security_group" "redis_sglat26" {
  name        = "redis_sglat26"
...
resource "aws_elasticache_cluster" "external" {
  ...
  security_group_ids   = [aws_security_group.redis_sglat26.id]
}

resource "aws_elasticache_subnet_group" "redis_subnets" {
  name       = "redis-subnet-grouplat26"
  subnet_ids = data.aws_subnets.private.ids
}
...
# Lambda: trigger-apilat26
resource "aws_lambda_function" "trigger_api" {
  function_name = "trigger-apilat26"
